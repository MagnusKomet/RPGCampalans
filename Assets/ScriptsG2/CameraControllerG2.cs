...
public class CameraControllerG2 : MonoBehaviour {
    ...
    void Start () {
        ...
        {
            bottomLeftCamLimit = new Vector3(-100, -100, 0f);
            topRightCamLimit = new Vector3(200, 200, 0f);
            playerController.SetPlayerBounds(bottomLeftCamLimit, topRightCamLimit);
        }
        else
        {
    ...
    void LateUpdate () {
        ...
        if (SceneManager.GetActiveScene().name == "LabrG2Scene")
        {
            bottomLeftCamLimit = new Vector3(-99999, -99999, 0f);
            topRightCamLimit = new Vector3(99999, 99999, 0f);
        }
